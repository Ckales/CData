...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1963818529;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__value__display_text_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__db__execute_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__db__fetch_window_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__db__fetch_window_text_impl(port, ptr, rust_vec_len, data_len),
        ...
        11 => wire__crate__api__schema__list_databases_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__schema__list_tables_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__connections__load_password_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__db__open_session_impl(port, ptr, rust_vec_len, data_len),
        15 => {
            wire__crate__api__connections__save_connection_impl(port, ptr, rust_vec_len, data_len)
        }
        16 => wire__crate__api__schema__with_order_by_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
